...
\todo[inline]{Here something about other ways of interacting with files, e.g. reading a list of keywords/sentiment bla bla from a line-ending separted text file; reading a folder with texts, reading json files into a dict (how does that work in R?)}
