...
in packages like \pkg{scikit-learn} or \pkg{seaborn} -- have a look at their documentation.
...
\pyrex[output=r, input=both, caption={A collection of US state-of-the-union speeches is available in multiple packages in various forms.}]{chapter06/sotudata}
