...
Now that you are familiar with data structures (\refchap{filetodata}) and data wrangling (\refchap{datawrangling}) you are probably eager to get some real insights of your data beyond the basic techniques we introduced in \refchap{fundata}.
