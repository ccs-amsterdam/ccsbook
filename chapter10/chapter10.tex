...
\pyrex[caption=Generating n-grams]{chapter11/ngram}
...
\pyrex[caption=Words and bigrams containing ``government'',output=r,format=table]{chapter11/ngram2}
...
\begin{ccsexample}
\doublecodex{chapter11/colloc}
\codexoutputtable{chapter11/colloc.r}
\doublecodex{chapter11/colloc2}
\codexoutputtable{chapter11/colloc2.r}
...
\begin{ccsexample}
\doublecodex{chapter11/embeddings0}
\doublecodex{chapter11/embeddings1}
\codexoutputtable{chapter11/embeddings1.r}
\doublecodex{chapter11/embeddings2}
\codexoutputtable{chapter11/embeddings2.r}
\doublecodex{chapter11/embeddings3}
\codex[caption=Output]{chapter11/embeddings3.r.out}
...
\pyrex[caption=Using UDPipe to analyze a sentence,format=table,output=r.]{chapter11/udpipe}
...
\pyrex[caption=Nouns used in the most recent State of the Union addresses,format=png,output=py]{chapter11/nouncloud}
...
\begin{ccsexample}
  \doublecodex{chapter11/spacymodel}
  \doublecodex{chapter11/spacy}
  \codexoutputtable{chapter11/spacy.r}
