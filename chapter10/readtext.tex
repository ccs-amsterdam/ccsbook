...
\note{\textbf{Important: Unicode and Encodings}
  ...
  Please see \refsec{unicode} for more information on how this works and how to make sure that you 
  }
...
This is reflected of course in the type name, with R calling it a \concept{character} and Python a \concept{string}.
...
As a simple example, \reffig{text} shows how the text `This is a text.' is represented.
