...
in all folds. Example~\refex{crossval} performs a cross-validation
...
not to use bootstrapping. \refex{gridsearch} illustrates how you can automatically assess which values you should choose.
