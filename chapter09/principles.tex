...
frequencies.
\refex{nb} shows how easy it is to train a classifier.
...
To do so, we rely on two measures: \emph{precision} and \emph{recall}, both of which are calculated in \refex{classificationreport}.
