...
Our examples in \refsec{principles} illustrate how to train a Na\"ive Bayes classifier.
...
The confusion matrix from \refex{classificationreport} tells us how many non-users were indeed
...
are interested in finding true users, we get a precision of $\frac{212}{212+106} = .67$ 
 and a recall of $\frac{212}{212+40} = .84$.
