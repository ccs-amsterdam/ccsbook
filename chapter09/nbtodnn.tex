...
models with multiple nominal outcomes instead of a binary outcome. In \refex{logreg} w	e fit the logistic regression using the \pkg{caret} method \fn{logreg} in R and the \pkg{sklearn} (module linear\_model) function \fn{LogisticRegression} in Python.
