...
\lstnewenvironment{ex_r_out}{\lstset{basicstyle=\footnotesize\ttfamily,
		columns=flexible,
		breaklines=true, 
		numbers=left,
		%stepsize=1,
...
\lstnewenvironment{ex_r_in}{\lstset{basicstyle=\footnotesize\ttfamily,
		columns=flexible,
		breaklines=true,
		numbers=left,
                showlines=true,
...
\lstnewenvironment{ex_py_out}{\lstset{basicstyle=\footnotesize\ttfamily,
		columns=flexible,
		breaklines=true,
		numbers=left,
		%stepsize=1,
...
\lstnewenvironment{ex_py_in}{\lstset{basicstyle=\footnotesize\ttfamily,
		columns=flexible,
		breaklines=true,
		numbers=left,
		%stepsize=1,
