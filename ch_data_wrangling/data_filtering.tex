...
\refex{data-filter} gives an example of loadnig and cleaning this data set, starting with the function \fn{read\_csv} (included in both \pkg{tidyverse} and \pkg{pandas}) to load the data directly from the Internet.
...
\pyrex[caption=Filter,output=r,format=table]{ch_data_wrangling/data-filter}
