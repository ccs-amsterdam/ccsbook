...
\note{\textbf{The Dirichlet Distribution and its Hyperparameters}
  ...
  and in fact Gensim provides algorithm to find, based on the data, an alpha that corresponds to this recommendation.
...
Second, we specify an `asymmetric' of \verb|1/1:10|, meaning the first topic has alpha 1, the second 0.5, etc.
