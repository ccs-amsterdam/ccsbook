...
All of these tools are available and well documented for Windows, Mac OS, and Linux. 
...
%TODO: Hoe werkt dit op mac?
In both cases, this should open a new window (usually black or grey) that allows you to type commands.

Note that on many computers, especially on Mac OS and Ubuntu, python is already installed by default.
...
Which will probably say something like \verb|Python 3.8.5|.
