...
by using a |:|. After the colon, in Python, we provide the index of
the element \emph{before} which we want to stop; in R, the element
with the provided index is included\footnote{This is related to the
