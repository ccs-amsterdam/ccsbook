...
vector objects in R. You can create them just by adding single or
...
\pyrex[input=py, output=py, caption=Numpy arrays behave more like R vectors]{chapter03/1darray7}
