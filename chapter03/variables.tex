...
In R, the \pkg{glue} package allows you to use a f-string-like syntax as well: \texttt{print(glue("The value of i is \{i\}"))}.
...
\pyrex[input=py, output=py, caption={Sets}]{chapter03/sets}
