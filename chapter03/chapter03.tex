...
% NOTE[WvA] This seems to be a dangling comment
% I have changed them to double quotes, however, please check that I have not inadvertently changed any which genuinely should be single quotes.}
