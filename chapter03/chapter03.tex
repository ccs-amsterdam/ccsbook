...
\begin{abstract}{Abstract}
  This chapter introduces readers to the basics of programming, data types, control strucutres, and functions
  in Python and R. It
...
print the string ``What a coincidence!'' if it is exactly 44 characters, and print ``NaN'' in all other cases.
