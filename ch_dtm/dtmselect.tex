...
\note{
  ...
  and where functions that can be called on a whole vector at once is called \em{vectorized}. 
...
\refex{trumptweets} shows how to load these tweets into a data frame containing the ID and text of the tweet,
creates a document-term matrix and shows the top words.

\pyrex[caption=Top words used in Trump Tweets,format=png]{ch_dtm/stopwords}
...
See \refchap{scraping} for information on how to use the Twitter API to collect your own data.
