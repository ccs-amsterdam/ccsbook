...
\todo[inline]{DO WE WANT CODE EXAMPLES? MAYBE THAT'S OUT OF SCOPE? AFTER ALL, WE WOULD ALSO NEED TO EXPLAIN HOW TO SET UP THE DATABASES ON DIFFERENT OS}
\label{sec:databases}
...
the data from your disk into memory\footnote{In fact, this is
  ...
  of data is in your memory at the same time.}.\todo{MAKE SURE WE
  COVER WHAT A GENERATOR IS IN AN EARLIER CHAPTER -- AT LEAST IN AN
  EXTRA FEATURE BOX}.
...
Luckily, you can outsorce all these problems to a database that you can
