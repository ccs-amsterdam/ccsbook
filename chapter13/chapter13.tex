...
\pyrex[output=py,caption={Loading and analyzing a real network of Spanish politicians and their followers on Twitter}]{chapter14/friends1}
...
\pyrex[output=both,format=png,caption=Visualizing the network of Spanish politicians and their followers on Twitter and plotting its clusters]{chapter14/friends2}
