...
\pyrex[output=none,caption=Create a data frame to plot the heatmap]{chapter08/pivot}
...
\pyrex[output=py,format=png,caption=Dendogram to visualize the hierarchical clustering]{chapter08/dendogram}
...
\pyrex[output=py,caption=Re-run hierarchical clustering with three clusters]{chapter08/hc3}

\pyrex[output=r,format=png,caption=Re-run hierarchical clustering with three clusters]{chapter08/vishc3}
...
\pyrex[output=py,caption=Principal component analysis (PCA) of a data frame with 30 records and 4 variables]{chapter08/pca}
