...
\pyrex[output=both,caption=Converting images to gray-scale and creating a two-dimensional array]{chapter15/imagel}
...
\pyrex[output=both,format=png,caption=Resize to $224 \times 224$ and visualize a picture]{chapter15/resize2}
...
\pyrex[output=both,caption=Comparing two flattened vectors to detect similarities between images]{chapter15/flatten}
...
\pyrex[output=py,caption=Creating the architecture of the MLP with \index{Keras}\emph{Keras}]{chapter15/mlp}
